...
#define CODEC_MAP(XX) \
    ...
    XX(CodecMP2V,  TrackVideo, 22, "MPV", PSI_STREAM_MPEG2, MOV_OBJECT_MP2V, MKV_CODEC_VIDEO_MPEG2)       \
    XX(CodecMP2A,  TrackAudio, 23, "MPA", PSI_STREAM_AUDIO_MPEG1, MOV_OBJECT_MP3, MKV_CODEC_AUDIO_MP1)
