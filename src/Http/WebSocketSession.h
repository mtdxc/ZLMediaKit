...
class SessionTypeImp : public SendInterceptor<SessionType> {
    std::string _identifier;
public:
    using Ptr = std::shared_ptr<SessionTypeImp>;

    SessionTypeImp(const Parser &header, const HttpSession &parent, const toolkit::Socket::Ptr &pSock) :
        SendInterceptor<SessionType>(pSock), _identifier(parent.getIdentifier()) {}
...
public:
    ...
    toolkit::Session::Ptr operator()(const Parser &header, const HttpSession &parent, const toolkit::Socket::Ptr &pSock){
...
template<typename SessionType, typename HttpSessionType = HttpSession>
class WebSocketSession : public WebSocketSessionBase<SessionCreator<SessionType>, HttpSessionType>{
public:
    WebSocketSession(const toolkit::Socket::Ptr &pSock) : WebSocketSessionBase<SessionCreator<SessionType>, HttpSessionType>(pSock){}
