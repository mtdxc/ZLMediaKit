var ZLMRTCClient = (function (exports) {
	...
	const BUILD_DATE = 'Tue Oct 29 2024 16:38:26 GMT+0800 (中国标准时间)';
	...
	*/
	...
	class RTCEndpoint extends Event$1 {
	  ...
	  configure(obj) {
	    if (this.id) {
	      let url = this.options.zlmsdpUrl;
	      url = url.substr(0, url.indexOf('/', url.indexOf("://") + 3));
	      url += "/index/api/config_webrtc?id=" + encodeURIComponent(this.id);
	      console.log(url, obj);
	      axios({
	        method: 'get',
	        url: url,
